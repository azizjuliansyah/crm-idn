...
import { Button, Table, TableHeader, TableBody, TableRow, TableCell, Label } from '@/components/ui';
             ...
             <Table className="border-collapse table-fixed">
                <TableHeader>
                   <TableRow className="bg-gray-50/50">
                      <TableCell isHeader className="px-8 py-5 text-[10px] uppercase tracking-widest text-center w-[340px]">Diagram Alir</TableCell>
                      <TableCell isHeader className="px-8 py-5 text-[10px] uppercase tracking-widest text-left w-48">Pelaksana</TableCell>
                      <TableCell isHeader className="px-8 py-5 text-[10px] uppercase tracking-widest text-left min-w-[400px]">Instruksi Pekerjaan</TableCell>
                      <TableCell isHeader className="px-8 py-5 text-[10px] uppercase tracking-widest text-left w-48">Dokumen</TableCell>
                   </TableRow>
                </TableHeader>
                <TableBody>
          ...
          <div className="bg-white rounded-3xl border border-gray-100 shadow-sm p-8 overflow-hidden">
             ...
             <div className="grid grid-cols-3 divide-x divide-gray-100 border border-gray-100 rounded-2xl overflow-hidden">
                <div className="p-6 text-center">
                   <Label className="uppercase tracking-widest mb-10 block">Disiapkan Oleh</Label>
                   <p className="text-xs font-bold text-gray-900">{sop.prepared_by || '-'}</p>
                </div>
                <div className="p-6 text-center">
                   <Label className="uppercase tracking-widest mb-10 block">Diperiksa Oleh</Label>
                   <p className="text-xs font-bold text-gray-900">{sop.checked_by || '-'}</p>
                </div>
                <div className="p-6 text-center">
                   <Label className="uppercase tracking-widest mb-10 block">Disahkan Oleh</Label>
