...
export const TaskSettingsView: React.FC<Props> = ({ company }) => {
  ...
  if (loading) return (
    <div className="flex flex-col items-center justify-center py-24 min-h-[400px]">
      ...
      <p className="text-[10px] font-black uppercase tracking-widest text-gray-400">Memuat Task Pipeline...</p>
    </div>
  );
    ...
    <div className="space-y-8 max-w-2xl">
      <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden shadow-sm">
        <div className="p-8 border-b border-gray-50 flex items-center justify-between">
          <div>
            <H2 className="text-lg uppercase tracking-tight font-black">Manajemen Task Pipeline</H2>
            <Subtext>Atur status pengerjaan untuk alur operasional tim.</Subtext>
          </div>
          <Button 
      ...
      <Modal 
        ...
        footer={
          <div className="flex w-full gap-3">
             <Button variant="ghost" onClick={() => setIsModalOpen(false)} className="flex-1 font-black text-xs uppercase tracking-widest">Batal</Button>
             <Button 
               onClick={handleSave} 
