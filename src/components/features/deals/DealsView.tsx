...
import { Button, Select, H1, Subtext, SearchInput } from '@/components/ui';
    ...
    <div className="h-full flex flex-col space-y-6">
      <div className="flex flex-col gap-4 bg-white p-4 rounded-2xl border border-gray-100 shadow-sm shrink-0">
        <div className="flex items-center justify-between">
          <div>
            <H1 className="text-xl font-black tracking-tight">Deals & Penjualan</H1>
            <Subtext className="text-[10px] font-bold uppercase tracking-widest leading-none">Monitoring transaksi dan pipeline penjualan.</Subtext>
          </div>
