        ...
        <div className="flex flex-col md:flex-row gap-12">
          <div className="w-full md:w-1/3 flex flex-col items-center gap-6">
            <div className="relative group">
              <div className="w-48 h-48 rounded-3xl bg-gray-50 border-2 border-dashed border-gray-200 flex items-center justify-center overflow-hidden shadow-none relative aspect-square">
                {coLogo ? (
              ...
              <label className="absolute -bottom-3 -right-3 w-12 h-12 bg-gray-900 text-white rounded-2xl flex items-center justify-center cursor-pointer hover:bg-black transition-all shadow-none active:scale-90 border-4 border-white aspect-square">
                <Camera size={20} />
          ...
          <div className="flex-1 space-y-8">
            <div className="space-y-2">
              ...
              <Input
                ...
                className="!px-6 !py-4 !rounded-2xl !text-lg shadow-none"
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                className="!px-6 !py-4 !rounded-2xl shadow-none !h-32"
