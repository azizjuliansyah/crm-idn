      ...
      <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden shadow-sm">
        ...
        <form onSubmit={handleSave} className="p-8 space-y-6">
            <div className="space-y-2">
               <Label className="uppercase tracking-widest">Mailketing API Token</Label>
               <Input 
                 type="password" 
                 value={apiToken}
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="space-y-2">
                 <Label className="uppercase tracking-widest">Nama Pengirim (From Name)</Label>
                 <Input 
                   type="text" 
                   value={fromName}
              ...
              <div className="space-y-2">
                 <Label className="uppercase tracking-widest">Email Pengirim (Sender Email)</Label>
                 <Input 
                   type="email" 
                   value={fromEmail}
           ...
           <div className="pt-4 flex items-center gap-3">
               <Button 
                 ...
                 className="!px-8 !py-3 shadow-lg shadow-indigo-100"
               >
                 Simpan Konfigurasi
               </Button>
           </div>
