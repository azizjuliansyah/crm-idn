...
export const ClientCompanyCategoryFormModal: React.FC<ClientCompanyCategoryFormModalProps> = ({
  ...
  return (
    <Modal 
      ...
      size="md"
      footer={
        <button onClick={(e) => onSave(form)} disabled={isProcessing} className="px-10 py-4 bg-indigo-600 text-white rounded-xl font-bold text-xs uppercase tracking-widest shadow-xl flex items-center gap-2">
