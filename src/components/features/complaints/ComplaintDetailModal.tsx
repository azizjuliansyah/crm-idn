...
export const ComplaintDetailModal: React.FC<Props> = ({
  ...
  const handleStatusChange = async (newStatus: string) => {
    ...
    try {
      ...
      showToast(`Status keluhan diubah ke ${newStatus.toUpperCase()}`, 'success');
      onUpdate();
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (error) throw error;
      showToast('Data keluhan berhasil diperbarui!', 'success');
      onUpdate();
      onClose();
    } catch (err: any) {
      showToast(err.message, 'error');
        ...
        <header className="px-6 h-16 flex items-center justify-between border-b border-gray-100 bg-white shrink-0">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 rounded-xl bg-blue-600 text-white flex items-center justify-center shrink-0 shadow-lg shadow-blue-100 group">
              ...
              <div className="flex items-start gap-4 mb-8">
                <div className="flex-1 relative">
                  <Textarea
                    ...
                    className="min-h-[90px] rounded-2xl border-gray-100 focus:border-primary-400 focus:ring-primary-400/10 transition-all text-xs font-medium placeholder:text-gray-300"
                  />
