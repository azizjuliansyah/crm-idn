...
import { Button, Input, Badge, Modal, H2, Subtext } from '@/components/ui';
...
export const LeadStagesSettingsView: React.FC<Props> = ({ company }) => {
  ...
  if (loading) return (
    <div className="flex flex-col items-center justify-center py-24">
      ...
      <p className="text-[10px] font-bold uppercase tracking-widest text-gray-400">Memuat Lead Pipeline...</p>
    </div>
  );
    ...
    <div className="space-y-8 max-w-2xl">
      <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden shadow-sm">
        <div className="p-8 border-b border-gray-50 flex items-center justify-between">
          <div>
            <H2 className="text-xl font-bold tracking-tight">Manajemen Lead Pipeline</H2>
