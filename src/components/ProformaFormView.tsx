      ...
      <div className="sticky top-0 z-30 bg-white border-b border-gray-100 px-10 py-5">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
           ...
           <div className="flex items-center gap-3">
              <button onClick={() => onNavigate ? onNavigate('daftar_proforma') : router.push('/dashboard/sales/proformas')} className="px-5 py-2.5 bg-white border border-gray-200 rounded-lg font-semibold text-sm text-gray-600 hover:bg-gray-50 transition-all">Batal</button>
              {editingId && (
                <button 
      ...
      <div className="max-w-7xl mx-auto px-10 py-8 space-y-6">
         <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-8">
            <div className="flex items-center gap-3 mb-8">
               ...
               <h2 className="text-base font-bold text-gray-800">Detail Proforma</h2>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-x-8 gap-y-6">
               ...
               <div className="space-y-1.5"><label className="text-[10px] font-bold text-gray-400 uppercase tracking-wider ml-1">Nomor Proforma</label><input type="text" value={proformaNumber} onChange={e => setProformaNumber(e.target.value)} className="w-full px-4 py-3 bg-white border border-gray-200 rounded-lg font-medium text-sm shadow-sm" /></div>
               <div className="space-y-1.5"><label className="text-[10px] font-bold text-gray-400 uppercase tracking-wider ml-1">Status</label><select value={status} onChange={e => setStatus(e.target.value)} className="w-full px-4 py-3 bg-white border border-gray-200 rounded-lg font-medium text-sm outline-none cursor-pointer shadow-sm"><option value="Draft">Draft</option><option value="Sent">Sent</option><option value="Paid">Paid</option></select></div>
               ...
               <div className="space-y-1.5"><label className="text-[10px] font-bold text-gray-400 uppercase tracking-wider ml-1">Batas Pembayaran</label><input type="date" value={dueDate} onChange={e => setDueDate(e.target.value)} className="w-full px-4 py-3 bg-white border border-gray-200 rounded-lg font-medium text-sm shadow-sm" /></div>
