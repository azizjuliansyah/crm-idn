    ...
    <div className="max-w-5xl space-y-8">
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
        <div className="p-10 border-b border-gray-50 flex items-center justify-between">
          <div>
            <h3 className="text-2xl font-bold text-gray-900 tracking-tighter">Project Pipeline Management</h3>
            <p className="text-sm text-gray-400 font-medium mt-1">Kelola tahapan pengerjaan proyek di workspace Anda.</p>
          </div>
          <button 
        ...
        <div className="overflow-x-auto">
          ...
          {pipelines.length === 0 && (
            <div className="py-20 text-center text-gray-300">
               ...
               <p className="text-xs font-bold uppercase tracking-widest">Belum ada project pipeline yang dikonfigurasi</p>
            </div>
          )}
        </div>
      </div>
        ...
        footer={
          <div className="flex gap-3">
            ...
            <button 
              ...
              className="px-10 py-3.5 bg-blue-600 text-white rounded-xl font-bold text-[10px] uppercase tracking-widest shadow-xl shadow-blue-100 hover:bg-blue-700 transition-all active:scale-95 disabled:opacity-50"
            >
        ...
        <div className="space-y-10 py-2">
          <div className="space-y-3">
            <div className="flex items-center gap-2">
              ...
              <label className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Nama Pipeline Proyek</label>
            </div>
            <input 
              type="text" 
            ...
            <div className="space-y-5">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <label className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Tahapan Kerja</label>
                </div>
              </div>
            ...
            <div className="space-y-5">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <label className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Custom Fields (Optional)</label>
                </div>
              </div>

              <div className="space-y-3">
                {modalForm.custom_fields.map((f, idx) => (
                  <div key={idx} className="flex items-center gap-4 p-4 bg-emerald-50/30 border border-emerald-100 rounded-2xl group animate-in slide-in-from-right-2">
              ...
              <div className="bg-gray-50 p-4 rounded-2xl border border-gray-100 space-y-3">
                ...
                <div className="flex gap-2">
                  <select 
                    ...
                    className="flex-1 px-4 py-3 bg-white border border-gray-200 rounded-xl text-[10px] font-bold uppercase tracking-widest outline-none"
                  >
      ...
      <Modal isOpen={confirmModal.isOpen} onClose={() => setConfirmModal({ isOpen: false, id: null })} title="Hapus Pipeline Permanen" size="sm">
        <div className="text-center py-8 space-y-6">
          ...
          <p className="text-xs text-gray-400 font-medium leading-relaxed">Seluruh data proyek yang berada dalam pipeline ini akan terpengaruh atau terhapus. Lanjutkan?</p>
          <div className="flex gap-3">
