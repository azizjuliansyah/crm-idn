...
export const LeadStagesSettingsView: React.FC<Props> = ({ company }) => {
  ...
  if (loading) return <div className="flex flex-col items-center justify-center py-24"><Loader2 className="animate-spin text-blue-600 mb-4" /><p className="text-[10px] font-bold uppercase tracking-widest text-gray-400">Memuat Lead Pipeline...</p></div>;
    ...
    <div className="space-y-8 max-w-2xl animate-in fade-in duration-500">
      <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden shadow-sm">
        <div className="p-8 border-b border-gray-50 flex items-center justify-between">
          <div>
            <h3 className="text-lg font-bold text-gray-900 tracking-tight">Manajemen Lead Pipeline</h3>
            <p className="text-xs text-gray-400 font-medium">Atur alur kualifikasi prospek baru ke dalam sistem.</p>
          </div>
          <button 
            ...
            return (
              <div key={stage.id} className="flex items-center justify-between p-4 bg-gray-50 border border-gray-100 rounded-xl hover:border-blue-200 transition-all group">
                <div className="flex items-center gap-4">
                  ...
                  {stage.is_system && <span className="px-2 py-0.5 bg-gray-200 text-gray-500 text-[8px] font-bold uppercase rounded">Sistem</span>}
